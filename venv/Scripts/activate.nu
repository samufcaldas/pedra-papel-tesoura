...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\samuf\PycharmProjects\rock-paper-scissors\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\samuf\PycharmProjects\rock-paper-scissors\venv\Scripts\deactivate.nu'
